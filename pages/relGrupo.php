               ...
               <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <?php echo "Relatorio dos grupos do curso de ".$_POST['txtNum']. " do ano de ".$_POST['txtAno']."/".$_POST['txtSem']; ?>
                        </div>
                        <!-- /.panel-heading -->
...
require_once 'conect.php';    
        ...
        $sql = "SELECT c.nome, p.ano, p.semestre, g.nome, a.nome
	FROM curso c, projeto p, grupo g, participa r, aluno a
	where c.numero = p.num_curso and p.numero = g.num_proj and g.id = r.id_grupo and r.matricula = a.matricula and p.ano = '".$_POST['txtAno']."' and p.semestre = '".$_POST['txtSem']."' order by g.nome";
